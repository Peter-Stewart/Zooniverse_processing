...
data{
  ...
  array[n_obs] real tree; // Number of trees (standardised)
...
// Priors
  ...
  beta_grass ~ normal(0,0.4); 
  beta_forb ~ normal(0,0.4);
  beta_shrub ~ normal(0,0.4);
  beta_succulent ~ normal(0,0.4); 
  beta_tree ~ normal(0,0.4);
  ...
  gamma_grass ~ normal(0,1); 
  gamma_forb ~ normal(0,1);
  gamma_shrub ~ normal(0,1);
  gamma_succulent ~ normal(0,1); 
  gamma_tree ~ normal(0,1);

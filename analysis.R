...
df_direct_baboon <- as.data.frame(cbind(post_direct_baboon$beta_opuntia, post_direct_baboon$beta_fruit))
df_direct_elephant <- as.data.frame(cbind(post_direct_elephant$beta_opuntia, post_direct_elephant$beta_fruit))
df_direct_vervetmonkey <- as.data.frame(cbind(post_direct_vervetmonkey$beta_opuntia, post_direct_vervetmonkey$beta_fruit))
df_direct_zebragrevys <- as.data.frame(cbind(post_direct_zebragrevys$beta_opuntia, post_direct_zebragrevys$beta_fruit))
df_direct_impala <- as.data.frame(cbind(post_direct_impala$beta_opuntia, post_direct_impala$beta_fruit))
df_direct_giraffe <- as.data.frame(cbind(post_direct_giraffe$beta_opuntia, post_direct_giraffe$beta_fruit))
df_direct_hyenaspotted <- as.data.frame(cbind(post_direct_hyenaspotted$beta_opuntia, post_direct_hyenaspotted$beta_fruit))
...
colnames(df_direct_baboon) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_elephant) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_vervetmonkey) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_zebragrevys) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_impala) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_giraffe) <- c("beta_opuntia", "beta_fruit", "species")
colnames(df_direct_hyenaspotted) <- c("beta_opuntia", "beta_fruit", "species")
...
# Get posterior samples for the estimands
df_total_no_veg_path_baboon <- as.data.frame(cbind(post_total_no_veg_path_baboon$beta_opuntia, post_total_no_veg_path_baboon$beta_fruit))
df_total_no_veg_path_elephant <- as.data.frame(cbind(post_total_no_veg_path_elephant$beta_opuntia, post_total_no_veg_path_elephant$beta_fruit))
df_total_no_veg_path_vervetmonkey <- as.data.frame(cbind(post_total_no_veg_path_vervetmonkey$beta_opuntia, post_total_no_veg_path_vervetmonkey$beta_fruit))
df_total_no_veg_path_zebragrevys <- as.data.frame(cbind(post_total_no_veg_path_zebragrevys$beta_opuntia, post_total_no_veg_path_zebragrevys$beta_fruit))
df_total_no_veg_path_impala <- as.data.frame(cbind(post_total_no_veg_path_impala$beta_opuntia, post_total_no_veg_path_impala$beta_fruit))
df_total_no_veg_path_giraffe <- as.data.frame(cbind(post_total_no_veg_path_giraffe$beta_opuntia, post_total_no_veg_path_giraffe$beta_fruit))
df_total_no_veg_path_hyenaspotted <- as.data.frame(cbind(post_total_no_veg_path_hyenaspotted$beta_opuntia, post_total_no_veg_path_hyenaspotted$beta_fruit))
...
colnames(df_total_no_veg_path_baboon) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_elephant) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_vervetmonkey) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_zebragrevys) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_impala) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_giraffe) <- c("beta_total1", "species")
colnames(df_total_no_veg_path_hyenaspotted) <- c("beta_total1", "species")
...
# Get posterior samples for the estimands
df_total_veg_path_baboon <- as.data.frame(cbind(post_total_veg_path_baboon$beta_opuntia, post_total_veg_path_baboon$beta_fruit))
df_total_veg_path_elephant <- as.data.frame(cbind(post_total_veg_path_elephant$beta_opuntia, post_total_veg_path_elephant$beta_fruit))
df_total_veg_path_vervetmonkey <- as.data.frame(cbind(post_total_veg_path_vervetmonkey$beta_opuntia, post_total_veg_path_vervetmonkey$beta_fruit))
df_total_veg_path_zebragrevys <- as.data.frame(cbind(post_total_veg_path_zebragrevys$beta_opuntia, post_total_veg_path_zebragrevys$beta_fruit))
df_total_veg_path_impala <- as.data.frame(cbind(post_total_veg_path_impala$beta_opuntia, post_total_veg_path_impala$beta_fruit))
df_total_veg_path_giraffe <- as.data.frame(cbind(post_total_veg_path_giraffe$beta_opuntia, post_total_veg_path_giraffe$beta_fruit))
df_total_veg_path_hyenaspotted <- as.data.frame(cbind(post_total_veg_path_hyenaspotted$beta_opuntia, post_total_veg_path_hyenaspotted$beta_fruit))
...
colnames(df_total_veg_path_baboon) <- c("beta_total2", "species")
colnames(df_total_veg_path_elephant) <- c("beta_total2", "species")
colnames(df_total_veg_path_vervetmonkey) <- c("beta_total2", "species")
colnames(df_total_veg_path_zebragrevys) <- c("beta_total2", "species")
colnames(df_total_veg_path_impala) <- c("beta_total2", "species")
colnames(df_total_veg_path_giraffe) <- c("beta_total2", "species")
colnames(df_total_veg_path_hyenaspotted) <- c("beta_total2", "species")
